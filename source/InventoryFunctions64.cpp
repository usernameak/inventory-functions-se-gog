...
//const RelocPtr<uintptr_t> s_ExtraPoisonVtbl(0x01770D10); // v2.2.6 (runtime 1.6.1170)
const RelocPtr<uintptr_t> s_ExtraPoisonVtbl(0x01771CD0); // v2.2.6 (runtime 1.6.1179 GOG)
